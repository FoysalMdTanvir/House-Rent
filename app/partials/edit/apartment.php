  		...
  		<form action="" method="POST">
		  	 <div class="row">
				...
				<div class="col-md-4">
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" pattern="^(\d{11})$" id="mobile" title="11 digit mobile number" placeholder="11 digit mobile number" name="mobile" value="<?php echo $data['mobile']?$data['mobile']:''; ?>" required>
				  </div>
				 </div>
				...
				<div class="col-md-4">
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" pattern="^(\d{11})$" id="alternat_mobile" title="11 digit mobile number" placeholder="11 digit mobile number" value="<?php echo $data['alternat_mobile']?$data['alternat_mobile']:''; ?>">
				  </div>
				</div>
			</div>
			...
			<div class="row">
			  ...
			  <div class="form-group">
			    ...
			    <input type="state" class="form-control" id="state" placeholder="Division" name="state" value="<?php echo $data['state']?$data['state']:''; ?>" required>
			  </div>
			  </div>
			  <div class="col-md-4">
			  <div class="form-group">
