  ...
  <body id="page-top">
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in"style="color:white">Welcome To House Rent!</div>
          <div class="intro-heading text-uppercase" style="color:red">It's Nice To See You<br></div>
        </div>
      </div>
    </header>
                        ...
                        <div class="card-block">';
                         ...
                         echo   '<div class="row">
                            ...
                            <h4 class="text-center">Owner Details</h4>';
                              ...
                              echo '<p><b>Country: </b>'.$value['country'].'</p><p><b> Division: </b>'.$value['state'].'</p><p><b> City: </b>'.$value['city'].'</p>';
    ...
    <footer style="background-color: #ccc;">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <span class="copyright">Children Of Bgctub</span>
          </div>
          <div class="col-md-4">
            <ul class="list-inline social-buttons">
              ...
              <li class="list-inline-item">
                <a href="https://www.facebook.com/tanvir.faisal.92/">
